...
This is the canonical entrance to PolySia documentation. Current repository
...
- [Capability catalog](01-discovery/capability-catalog.md)
...
- [Current evidence index](18-ai-handoffs/README.md)
- [Immutable baseline audit](13-ai-handoffs/BASELINE_AUDIT.md)

## Historical archive

- [Archived documentation](99-archive/)

Archived records preserve provenance, audit, migration, safety, operational,
and rollback evidence. They are not current operating instructions unless a
current authoritative document explicitly incorporates them.
