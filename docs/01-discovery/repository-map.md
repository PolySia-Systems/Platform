...
| Path | Role |
|---|---|
| `src/polysia/` | Canonical application package after naming migration |
| `tests/` | Unit, contract, integration, property, and end-to-end suites |
| `docs/00-governance/` | Charter, control, naming, and registers |
| `docs/01-discovery/` | Baseline, capability, and repository discovery |
| `docs/02-research/` | Versioned external evidence |
