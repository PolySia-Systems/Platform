...
|---|---|---|---|---|---|---|
| PolySia modular monolith | CURRENT | `src/polysia/`, `pyproject.toml` | `tests/migration/test_identity.py`, `tests/architecture/test_boundaries.py` | CAP-001–012 | ADR-0001, ADR-0002 | One Python distribution and deployable modular monolith |
| CLI and safe support | CURRENT | `src/polysia/cli.py`, `src/polysia/cli_support/` | `tests/characterization/test_cli_contract.py` | CAP-011, CAP-012 | ADR-0002 | Contract-tested command inventory, including the bounded `control` group |
