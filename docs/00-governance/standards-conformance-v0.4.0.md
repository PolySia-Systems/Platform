# Standards v0.4.0 Final Conformance Review

## Decision

PolySia Platform conforms to the exact immutable
`PolySia-Systems/Standards` release `v0.4.0` at commit
`4ee4e6aca8f0a38379f18029f8db71828cd00759` for the selected `PRF-BASE` and
