...
| Authority | Conformant consumer adoption for the selected v0.4.0 profiles |
| Consumer identity | `PolySia-Systems/Platform` |
| Accountable Consumer Owner | PolySia Platform Owner |
| Standards release | `v0.4.0` |
| Released commit | `4ee4e6aca8f0a38379f18029f8db71828cd00759` |
...
| Exact tag | PASS | `refs/tags/v0.4.0` resolves directly to commit `4ee4e6aca8f0a38379f18029f8db71828cd00759` |
| Final release | PASS | GitHub Release `376509086`, published 2026-08-25, is neither Draft nor prerelease |
...
Release evidence: <https://github.com/PolySia-Systems/Standards/releases/tag/v0.4.0>.
...
|---|---|---|---|
| `PRF-BASE@v0.4.0` | Platform is a PolySia-controlled repository with durable paths, current documents, repository identity, and an explicit adoption | Active since `v0.1.0`; present and unchanged in immutable `v0.4.0` | Repository metadata, tracked inventory, this record |
| `PRF-PYS@v0.4.0` | Platform is a maintained, installable Python project intended for repeatable execution and reuse | Active since `v0.1.0`; present and unchanged in immutable `v0.4.0` | `pyproject.toml`, `src/polysia/`, `tests/`, locks, and CI |
