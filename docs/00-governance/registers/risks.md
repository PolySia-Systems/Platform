...
| RSK-002 | Beta SDK drift changes signing or responses. | High | High | Exact b11 pin, contract tests, upgrade/rollback runbook. |
...
| RSK-010 | Local bounded monitoring is mistaken for continuous production supervision. | Medium | High | Document one-shot/bounded behavior; scheduling and external alert providers remain deferred. |
