...
| DEP-001 | SDK | `polymarket-client==0.6.0`. | Verified | Upgrade only with contract, lock, security, CI, and rollback evidence. |
...
| DEP-004 | Tooling | Mypy 2.3.0 and Ruff 0.16.4. | Verified | Upgrade only with synchronized lock and reproducibility validation. |
