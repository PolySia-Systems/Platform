...
def render_strategy_evaluation_markdown(report: StrategyEvaluationReport) -> str:
    ...
    return "\n".join(
        (
            "# PolySia — Polymarket Adapter — Strategy Evaluation",
            "",
...
<head>
  ...
  <title>PolySia — Polymarket Adapter — Strategy Evaluation</title>
  <style>
...
<body>
  <main>
    <h1>PolySia — Polymarket Adapter — Strategy Evaluation</h1>
