...
from pm_trader.deployment.automation import DeploymentAutomationResult
    ...
    return "\n".join(
        (
            ...
            *_artifact_lines(result),
            ...
            "- `python -m pm_trader.cli deployment-automation --require-clean-git "
            ...
            "- `python -m pm_trader.cli post-live-reconciliation --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli observability-snapshot --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli shadow-run-real-data --auto-btc-5m "
            "--max-events 100 --output-dir .\\release-artifacts`",
            "- `python -m pm_trader.cli strategy-evaluation-extended --input "
            ".\\release-artifacts\\shadow-run-real-data.json --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli tiny-live-monitor --output-dir "
            ".\\release-artifacts --redact-secrets`",
            "- `python -m pm_trader.cli controlled-second-tiny-live --auto-btc-5m "
            "--side BUY --outcome YES --max-notional 1.00 --order-type FOK "
            "--dry-run --output-dir .\\release-artifacts`",
            "- `python -m pm_trader.cli production-gap-audit --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli main-merge-review --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli local-release-closeout --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli reconcile-account --output-dir "
            ".\\release-artifacts`",
            "- `python -m pm_trader.cli manual-intervention-live-test --auto-btc-5m "
