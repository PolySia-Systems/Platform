...
from pm_trader.execution.intents import OrderSide
...
def render_fill_simulation_audit_markdown(report: FillSimulationAuditReport) -> str:
    ...
    return "\n".join(
        (
            "# Polymarket Fill Simulation Audit",
            "",
...
<head>
  ...
  <title>Polymarket Fill Simulation Audit</title>
  <style>
...
<body>
  <main>
    <h1>Polymarket Fill Simulation Audit</h1>
